...
export function AnalysisResult({ result }: AnalysisResultProps) {
  ...
  // Debug: mostrar colores detectados en consola
  console.log('Colores detectados:', displayMatches.map(m => ({
    param: m.parameter,
    detected: m.detectedColor,
    reference: m.referenceColor
  })));
      ...
      {displayConfidence < 70 && (
        <div className="bg-yellow-50 border border-yellow-300 rounded-xl p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="font-semibold text-yellow-800 text-sm">Precisión baja</div>
