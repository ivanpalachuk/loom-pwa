            ...
            <PageHeader 
                ...
                action={
                    ...
                    >
                        ...
                        {cartCount > 0 && (
                            <span className="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-[10px] md:text-xs font-bold rounded-full min-w-[18px] h-[18px] md:min-w-[20px] md:h-[20px] flex items-center justify-center shadow-lg border-2 border-white">
