                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center border-2 border-gray-200 rounded-lg overflow-hidden bg-white">
                            <button
                                ...
                                disabled={quantity <= 1}
                                className="px-2.5 py-2 bg-gray-50 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors active:bg-gray-200"
                            >
                                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M20 12H4" />
                                </svg>
                            </button>
                            <span className="px-3 py-2 font-bold text-sm min-w-[40px] text-center">
                                {quantity}
                            </span>
                            <button
                                onClick={(e) => handleQuantityChange(e, 1)}
                        ...
                        <button
                            ...
                            disabled={isAdding}
                            className="flex-1 relative overflow-hidden rounded-lg font-semibold transition-all group shadow-md active:scale-95"
                        >
                            {/* Fondo con patrón */}
                            <div className={`absolute inset-0 transition-colors ${isAdding ? 'bg-green-500' : 'bg-loom'}`}>
                                <div 
                            ...
                            {/* Contenido del botón */}
                            <div className="relative z-10 py-2.5 px-4 text-white">
                                {isAdding ? (
